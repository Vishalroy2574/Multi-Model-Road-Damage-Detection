...
2. cd spothole
3. npm install 
4. Set `MONGODB_URI`, `SESSION_SECRET`, and `APP_BASE_URL` in `.env`.
5. Use a `@gmail.com` email address to sign up or log in.
6. Set up the backend services described in the project readme.
7. Once your backend is working, test the local APIs using a tool like Postman.
